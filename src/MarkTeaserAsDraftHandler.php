...
class MarkTeaserAsDraftHandler extends AbstractMarkNodeAsDraftHandler
{
    ...
    public static function handlesCuries(): array
    {
        ...
        return [
            SchemaCurie::fromString("{$curie->getVendor()}:{$curie->getPackage()}:command:mark-teaser-as-draft"),
        ];
    }
}
