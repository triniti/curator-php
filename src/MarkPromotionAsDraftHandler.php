...
class MarkPromotionAsDraftHandler extends AbstractMarkNodeAsDraftHandler
{
    ...
    public static function handlesCuries(): array
    {
        ...
        return [
            SchemaCurie::fromString("{$curie->getVendor()}:{$curie->getPackage()}:command:mark-promotion-as-draft"),
        ];
    }
}