...
class MarkTeaserAsPendingHandler extends AbstractMarkNodeAsPendingHandler
{
    ...
    public static function handlesCuries(): array
    {
        ...
        return [
            SchemaCurie::fromString("{$curie->getVendor()}:{$curie->getPackage()}:command:mark-teaser-as-pending"),
        ];
    }
}
